...
import com.example.proyectofinal.dataLayer.repositories.network.PuppyRepository
...
class ViewModelDog(var roomRepository: PuppyRepositoryRoom) : ViewModel() {
...
class ViewModelFactory(private val repository: PuppyRepositoryRoom) : ViewModelProvider.Factory {
